<?php //netteCache[01]000559a:2:{s:4:"time";s:21:"0.79750600 1478265271";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:73:"/home/niko/directory/public_html/wp-content/themes/directory2/@layout.php";i:2;i:1478264647;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.0";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"1.65";}}}?><?php

// source file: /home/niko/directory/public_html/wp-content/themes/directory2/@layout.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, '3pbybmunw2')
;
// prolog NUIMacros
...
<?php if ($headerLayoutType == 'revslider') { if ($elements->unsortable['revolution-slider']->display) { NCoreMacros::includeTemplate($elements->unsortable['revolution-slider']->getTemplate(), array('el' => $elements->unsortable['revolution-slider'], 'element' => $elements->unsortable['revolution-slider'], 'htmlId' => $elements->unsortable['revolution-slider']->getHtmlId(), 'htmlClass' => $elements->unsortable['revolution-slider']->getHtmlClass()) + $template->getParameters(), $_l->templates['3pbybmunw2'])->render() ;} } elseif ($headerLayoutType == 'map') { if ($elements->unsortable['header-map']->display) { NCoreMacros::includeTemplate($elements->unsortable['header-map']->getTemplate(), array('el' => $elements->unsortable['header-map'], 'element' => $elements->unsortable['header-map'], 'htmlId' => $elements->unsortable['header-map']->getHtmlId(), 'htmlClass' => $elements->unsortable['header-map']->getHtmlClass()) + $template->getParameters(), $_l->templates['3pbybmunw2'])->render() ;} } elseif ($headerLayoutType == 'video') { if ($elements->unsortable['header-video']->display) { NCoreMacros::includeTemplate($elements->unsortable['header-video']->getTemplate(), array('el' => $elements->unsortable['header-video'], 'element' => $elements->unsortable['header-video'], 'htmlId' => $elements->unsortable['header-video']->getHtmlId(), 'htmlClass' => $elements->unsortable['header-video']->getHtmlClass()) + $template->getParameters(), $_l->templates['3pbybmunw2'])->render() ;} } elseif ($headerLayoutType == 'image') { if ($headerImageHeight != "") { ?>
...
<?php if ($elements->unsortable['search-form']->display) { NCoreMacros::includeTemplate($elements->unsortable['search-form']->getTemplate(), array('el' => $elements->unsortable['search-form'], 'element' => $elements->unsortable['search-form'], 'htmlId' => $elements->unsortable['search-form']->getHtmlId(), 'htmlClass' => $elements->unsortable['search-form']->getHtmlClass()) + $template->getParameters(), $_l->templates['3pbybmunw2'])->render() ;} ?>
	</div>
</div>
<div id="main" class="elements">

<?php if ($elements->unsortable['page-title']->display) { NCoreMacros::includeTemplate($elements->unsortable['page-title']->getTemplate(), array('el' => $elements->unsortable['page-title'], 'element' => $elements->unsortable['page-title'], 'htmlId' => $elements->unsortable['page-title']->getHtmlId(), 'htmlClass' => $elements->unsortable['page-title']->getHtmlClass()) + $template->getParameters(), $_l->templates['3pbybmunw2'])->render() ;} ?>
...
<?php NCoreMacros::includeTemplate($element->getTemplate(), array('el' => $element, 'element' => $element, 'htmlId' => $element->getHtmlId(), 'htmlClass' => $element->getHtmlClass()) + $template->getParameters(), $_l->templates['3pbybmunw2'])->render() ?>
