<?php //netteCache[01]000601a:2:{s:4:"time";s:21:"0.26711300 1478265272";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:114:"/home/niko/directory/public_html/wp-content/themes/directory2/ait-theme/elements/taxonomy-list/taxonomy-list.latte";i:2;i:1478264647;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.0";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:4:"1.65";}}}?><?php

// source file: /home/niko/directory/public_html/wp-content/themes/directory2/ait-theme/elements/taxonomy-list/taxonomy-list.latte

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'dtgj106r1k')
;
// prolog NUIMacros
...
// main template
//
NCoreMacros::includeTemplate($element->common('header'), $template->getParameters(), $_l->templates['dtgj106r1k'])->render() ?>
...
<?php if (is_array($terms) && count($terms) > 0) { $layout = $el->option->layout ;$imageGrey = $el->option->imageGrey ;$imageDisplay = $taxonomy == 'ait-locations' ? $el->option->imageDisplay : 'icon' ;if ($layout == 'box') { $enableCarousel  = $el->option->boxEnableCarousel ;$boxAlign 		  = $el->option->boxAlign ;$numOfRows       = $el->option->boxRows ;$numOfColumns    = $el->option->boxColumns ;$displayDesc	  = $el->option->boxDisplayDesc ;$textRows 		  = $el->option->boxTextRows ;$imageHeight     = $el->option->boxImageHeight ?>
			<?php if ($taxonomy == 'ait-locations') { $imgWidth = 250 ?>
			<?php } else { ?>												<?php $imgWidth = 80 ;} ?>

<?php } elseif ($layout == 'icon') { $enableCarousel  = $el->option->iconEnableCarousel ;$boxAlign 		  = $el->option->iconAlign ;$numOfRows       = 1 ;$numOfColumns    = 6 ;$imageHeight     = $el->option->iconImageHeight ;$imgWidth = 80 ;} else { $enableCarousel  = $el->option->listEnableCarousel ;$numOfRows       = $el->option->listRows ;$numOfColumns    = $el->option->listColumns ;$displayDesc	  = $el->option->listDisplayDesc ;$textRows 		  = $el->option->listTextRows ;$imageHeight     = $el->option->listImageHeight ;$imgWidth = 80 ;} ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("ait-theme/elements/taxonomy-list/javascript", ""), array('enableCarousel' => $enableCarousel) + get_defined_vars(), $_l->templates['dtgj106r1k'])->render() ?>
