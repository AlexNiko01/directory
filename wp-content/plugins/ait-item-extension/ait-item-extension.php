																	...
																	foreach(AitLangs::getLanguagesList() as $lang){
																		...
																		if(!AitLangs::isFilteredOut($lang)){
																			echo '<div class="ait-opt-wrapper '.AitLangs::htmlClass($lang->locale).'">';
																				...
																				$value = is_array($generalSettings['section_title']) ? $generalSettings['section_title'][$lang->locale] : $generalSettings['section_title'];
																				echo '<input type="text" value="'.$value.'" data-lang="'.$lang->locale.'">';
																			echo '</div>';
																		} else {
																			$value = is_array($generalSettings['section_title']) ? $generalSettings['section_title'][$lang->locale] : "";
																	...
																	foreach(AitLangs::getLanguagesList() as $lang){
																		...
																		if(!AitLangs::isFilteredOut($lang)){
																			echo '<div class="ait-opt-wrapper '.AitLangs::htmlClass($lang->locale).'">';
																				...
																				$value = is_array($generalSettings['section_description']) ? $generalSettings['section_description'][$lang->locale] : $generalSettings['section_description'];
																				echo '<textarea data-lang="'.$lang->locale.'">'.$value.'</textarea>';
																			echo '</div>';
																		} else {
																			$value = is_array($generalSettings['section_description']) ? $generalSettings['section_description'][$lang->locale] : "";
																			echo '<input type="hidden" value="'.$value.'" data-lang="'.$lang->locale.'">';
																		}
